...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { caption: @gallery.caption, date_added: @gallery.date_added, image_url: @gallery.image_url }
    end
  ...
  test "should update gallery" do
    put :update, id: @gallery, gallery: { caption: @gallery.caption, date_added: @gallery.date_added, image_url: @gallery.image_url }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
